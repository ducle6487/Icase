...
public class ProductService {
	...
	// caseBuying.image = jdbcTemplate.query("select top 2 * from image where
	...
	public List<PhoneModel> getListPhonesByProductId(String id) {
		String sql = "SELECT ph.* FROM dbo.device de,dbo.\"Phone\" ph WHERE ph.idphone = de.idphone and de.idproduct = "
				+ id;
		List<PhoneModel> phonesList = jdbcTemplate.query(sql, new PhoneMapper());
	...
	public List<NewsModel> getList3NewNews() {
		String sql = "SELECT * FROM dbo.news ORDER BY \"IdNews\" DESC";
